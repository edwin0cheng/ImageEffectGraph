...
[assembly: OptionalDependency("UnityEngine.Experimental.Rendering.HDPipeline.HDRenderPipelineAsset", "USE_HD_PIPELINE")]
...
//                subShader.AppendLines(tagsBuilder.ToString());
        ...
        {
            var pathSegments = new[] { ImageEffectGraphPackageInfo.assetPackagePath, "Editor", "Pipelines", "HDRP", templateName };
